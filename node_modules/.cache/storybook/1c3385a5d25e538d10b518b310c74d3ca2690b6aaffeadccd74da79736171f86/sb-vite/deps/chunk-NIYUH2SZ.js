import {
  ...
  ScrollArea,
  SyntaxHighlighter2
} from "./chunk-VK5LAHRK.js";
import {
  WithToolTipState
} from "./chunk-UIWSWNZ6.js";
import {
  ...
  newStyled,
  typography
} from "./chunk-7NLT6U7V.js";
import {
  __export as __export2
} from "./chunk-NCYI2GVL.js";
import {
  O
} from "./chunk-RAMHFXKH.js";
import {
...
var $8927f6f2acc4f386$export$250ffa63cdc0d034 = $8927f6f2acc4f386$var$NODES.reduce((primitive, node) => {
  const Node = (0, import_react5.forwardRef)((props, forwardedRef) => {
    ...
    return (0, import_react5.createElement)(Comp2, _extends({}, primitiveProps, {
      ref: forwardedRef
    }));
  });
...
function $d3863c46a17e8a28$var$arrayRemove(array, item) {
  ...
  if (index3 !== -1) updatedArray.splice(index3, 1);
  return updatedArray;
}
...
function darken(amount, color2) {
  ...
  return toColorString(_extends2({}, hslColor, { lightness: guard(0, 1, hslColor.lightness - parseFloat(amount)) }));
}
...
function transparentize(amount, color2) {
  if (color2 === "transparent") return color2;
  var parsedColor = parseToRgb(color2), alpha = typeof parsedColor.alpha == "number" ? parsedColor.alpha : 1, colorWithAlpha = _extends2({}, parsedColor, { alpha: guard(0, 1, +(alpha * 100 - parseFloat(amount) * 100).toFixed(2) / 100) });
...
var LazySyntaxHighlighter = (0, import_react16.lazy)(async () => {
  let { SyntaxHighlighter: SyntaxHighlighter3 } = await import("./syntaxhighlighter-BP7B2CQK-DNQKIKP6.js");
...
var LazySyntaxHighlighterWithFormatter = (0, import_react16.lazy)(async () => {
  let [{ SyntaxHighlighter: SyntaxHighlighter3 }, { formatter }] = await Promise.all([import("./syntaxhighlighter-BP7B2CQK-DNQKIKP6.js"), import("./formatter-2WMMO6ZP-VAPU5YJK.js")]);
  return languages.length > 0 && (languages.forEach((args) => {
    SyntaxHighlighter3.registerLanguage(...args);
...
var ErrorFormatter = ({ error }) => {
  ...
  if (!error.stack) return import_react16.default.createElement(import_react16.Fragment, null, error.message || "This error has no stack or message");
...
var TextareaAutosize = function(_ref, userRef) {
  ...
  return React32.useLayoutEffect(resizeTextarea), useWindowResizeListener(resizeTextarea), useFontsLoadedListener(resizeTextarea), React32.createElement("textarea", _extends2({}, props, { onChange: handleChange, ref }));
};
...
var LazyWithTooltip = (0, import_react16.lazy)(() => import("./WithTooltip-KJL26V4Q-ICJNEM6Y.js").then((mod) => ({ default: mod.WithTooltip })));
...
var LazyWithTooltipPure = (0, import_react16.lazy)(() => import("./WithTooltip-KJL26V4Q-ICJNEM6Y.js").then((mod) => ({ default: mod.WithTooltipPure })));
...
var Loader = ({ progress, error, size, ...props }) => {
  if (error) return import_react16.default.createElement(ProgressWrapper, { "aria-label": error.toString(), "aria-live": "polite", role: "status", ...props }, import_react16.default.createElement(ErrorIcon, null), import_react16.default.createElement(ProgressMessage, null, error.message));
  if (progress) {
...
//# sourceMappingURL=chunk-NIYUH2SZ.js.map
